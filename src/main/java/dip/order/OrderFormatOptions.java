...
public class OrderFormatOptions implements Cloneable {
     ...
     */
    public static final String[] ARROWS = {ARROW_DEFAULT, ARROW_HYPHEN, ARROW_UNICODE};
    ...
    public char getCoastSeparator() {
        if (getCoastFormat() == FORMAT_COAST_PAREN_BRIEF || getCoastFormat() == FORMAT_COAST_PAREN_FULL) {
