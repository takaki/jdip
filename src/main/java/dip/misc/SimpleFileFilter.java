...
public class SimpleFileFilter extends FileFilter implements FilenameFilter {
     ...
     */
    public static final SimpleFileFilter SAVE_GAME_FILTER = new SimpleFileFilter(
            Utils.getLocalString("SimpleFileFilter.savegame.extension"),
            Utils.getLocalString("SimpleFileFilter.savegame.description"));

    /**
     * JPEG file filter
     */
    public static final SimpleFileFilter JPG_FILTER = new SimpleFileFilter(
            "jpg", Utils.getLocalString("SimpleFileFilter.jpg.description"));

    /**
     * PNG file filter
     */
    public static final SimpleFileFilter PNG_FILTER = new SimpleFileFilter(
            "png", Utils.getLocalString("SimpleFileFilter.png.description"));

    /**
     * SVG file filter
     */
    public static final SimpleFileFilter SVG_FILTER = new SimpleFileFilter(
            "svg", Utils.getLocalString("SimpleFileFilter.svg.description"));

    /**
     * PDF file filter
     */
    public static final SimpleFileFilter PDF_FILTER = new SimpleFileFilter(
            "pdf", Utils.getLocalString("SimpleFileFilter.pdf.description"));

    /**
     * XML file filter
     */
    public static final SimpleFileFilter XML_FILTER = new SimpleFileFilter(
            "xml", Utils.getLocalString("SimpleFileFilter.xml.description"));

    /**
     * HTML file filter
     */
    public static final SimpleFileFilter HTML_FILTER = new SimpleFileFilter(
            "html", Utils.getLocalString("SimpleFileFilter.html.description"));

    /**
     * TXT (plain text) file filter
     */
    public static final SimpleFileFilter TXT_FILTER = new SimpleFileFilter(
            "txt", Utils.getLocalString("SimpleFileFilter.txt.description"));
    ...
    private boolean isMatch(final String filename) {
        ...
        for (int i = dextLen - 1; i >= 0; i--) {
            if (Character.toLowerCase(filename.charAt(count)) != dottedExt
                    .charAt(i)) {
                return false;
            }
