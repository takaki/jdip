...
public class Help {
    ...
    public static class HelpID {
         ...
         */
        public static final HelpID Dialog_StatusReport = new HelpID(
                "Reports_Status");
        /**
         * Result Report dialog help
         */
        public static final HelpID Dialog_ResultReport = new HelpID(
                "Reports_Results");
        /**
         * Phase Select dialog help
         */
        public static final HelpID Dialog_PhaseSelect = new HelpID(
                "History_Select");
        /**
         * Order Checking (validation) dialog help
         */
        public static final HelpID Dialog_OrderChecking = new HelpID(
                "Order_Checking");
        /**
         * Judge Import Help
         */
        public static final HelpID Dialog_ImportJudge = new HelpID(
                "import_judge_htm");
        /**
         * floc.net Import Help
         */
        public static final HelpID Dialog_ImportFloc = new HelpID(
                "import_floc_htm");
