...
public class AIDemo {
     ...
     */
    private World createStandardWorld() throws Exception {
        ...
        //
        System.out.println("\nEqualities:");
        System.out.println("   loc1 and prov: same province? " + loc1
                .isProvinceEqual(prov));
        System.out.println("   loc2 and prov: same province? " + (loc2
                .getProvince() == prov));    // referential equality!
    ...
    private List[] createOrders(Map map, Position pos) {
        ...
        System.out.println(
                "Created " + orderLists.length + " sets of orders to evaluate.");
