...
public class ExportPreferencePanel extends PreferencePanel {
    ...
    public ExportPreferencePanel(final ClientFrame cf) {
        ...
        // category + choices
        add(new GradientJLabel(Utils.getLocalString(I18N_CAT_SIZE)),
                c.rcwh(2, 2, 3, 1, "lr"));
        add(jrb[0],
                c.rcwh(4, 3, 3, 1));    // this one has a text label; it's wider
        add(jrb[1], c.rc(6, 3));
        add(jrb[2], c.rc(8, 3));
        add(jrb[3], c.rc(10, 3));
        ...
        panel.add(
                new JLabel(Utils.getLocalString(I18N_CHOICE_SIZE_HEIGHTONLY)));
        add(panel, c.rcwh(10, 4, 1, 1, "l"));


        // category + choices
        add(new GradientJLabel(Utils.getLocalString(I18N_CAT_SETTINGS)),
                c.rcwh(12, 2, 3, 1, "lr"));
    ...
    private void makeAndSetGUIItems() {
        ...
        imgWidthOnly = new JSpinner(
                new SpinnerNumberModel(0, 0, MAX_IMG_SIZE, 1));
        imgHeightOnly = new JSpinner(
                new SpinnerNumberModel(0, 0, MAX_IMG_SIZE, 1));
