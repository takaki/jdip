...
public class NewGameDialog extends HeaderDialog {
    ...
    public static World displayDialog(final ClientFrame parent, final String title,
        ...
        dialogInstance.getRootPane().setDefaultButton(
                defaultButton); // ok button should be default button
     ...
     */
    public static synchronized void createCachedDialog(
            final ClientFrame parent) {
