...
public class PersistenceManager {
    ...
    public PersistenceManager(final ClientFrame clientFrame) {
        ...
        persistTG = new ThreadGroup(Thread.currentThread().getThreadGroup(),
                "jdipPMGroup");
        ...
        clientFrame.addPropertyChangeListener(ClientFrame.EVT_MODIFIED_STATE,
                modListener);
    }// PersistenceManager()
    ...
    private void openWorld(final World world, final File file) {
        ...
        clientFrame.getClientMenu()
                .setSelected(ClientMenu.EDIT_EDIT_MODE, false);
    ...
    public World importJudge(final File file, World currentWorld) {
        ...
        try {
            JudgeImport ji = new JudgeImport(clientFrame.getGUIOrderFactory(),
                    file, currentWorld);
            ...
            while ((ji.getResult() == JudgeImport.JI_RESULT_TRYREWIND) || (ji
                ...
                if (ji.getResult() == JudgeImport.JI_RESULT_TRYREWIND) {
                    ...
                    if (rewindDialog(phase)) {
                        ...
                        final LinkedList<Phase> l = new LinkedList<>();
                        while (iter.hasNext()) {
                ...
                // try again.
                ji = new JudgeImport(clientFrame.getGUIOrderFactory(), file,
                        currentWorld);
            }
    ...
    private void setTitle(final World localWorld) {
        ...
        if (localWorld != null || clientFrame.getWorld() != null) {
            ...
            if (Utils.isOSX()) {
                ...
                clientFrame.getRootPane().putClientProperty(WINDOW_MODIFIED,
