...
public abstract class RenderCommandFactory {
    ...
    /** */
    public abstract RCSetTurnstate createRCSetTurnstate(MapRenderer2 mr,
                                                        TurnState ts);

    /** */
    public abstract RCRenderProvince createRCRenderProvince(MapRenderer2 mr,
                                                            Province province);

    /** */
    public abstract RCSetLabel createRCSetLabel(MapRenderer2 mr,
                                                Object labelValue);

    /** */
    public abstract RCSetDisplaySC createRCSetDisplaySC(MapRenderer2 mr,
                                                        boolean value);

    /** */
    public abstract RCSetDisplayUnits createRCSetDisplayUnits(MapRenderer2 mr,
                                                              boolean value);

    /** */
    public abstract RCSetDisplayDislodgedUnits createRCSetDisplayDislodgedUnits(
            MapRenderer2 mr, boolean value);

    /** */
    public abstract RCSetDisplayUnordered createRCSetDisplayUnordered(
            MapRenderer2 mr, boolean value);

    /** */
    public abstract RCSetInfluenceMode createRCSetInfluenceMode(MapRenderer2 mr,
                                                                boolean value);

    /** */
    public abstract RCSetPowerOrdersDisplayed createRCSetPowerOrdersDisplayed(
            MapRenderer2 mr, Power[] displayedPowers);
