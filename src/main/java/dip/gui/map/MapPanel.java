...
public class MapPanel extends JPanel {
     ...
     * update text message
     */
    private static final String updateMessage = Utils
            .getLocalString("MapPanel.update.text");

    /**
     * Default cursor
     */
    public static final Cursor DEFAULT_CURSOR = java.awt.Cursor
            .getDefaultCursor();
    ...
    static {
        ...
        if (!d.equals(new Dimension(0, 0)) && (colors != 0)) {
            ...
            if (ii == null) {
                ...
                BAD_ACTION = tk.createCustomCursor(ii.getImage(),
                        new java.awt.Point(16, 16), "custom_nodrop");
            }
            ...
            if (ii == null) {
                ...
                CURSOR_DRAG_ARMY = tk.createCustomCursor(ii.getImage(),
                        new java.awt.Point(5, 5), "cursor_drag_army");
            }
            ...
            if (ii == null) {
                ...
                CURSOR_DRAG_FLEET = tk.createCustomCursor(ii.getImage(),
                        new java.awt.Point(5, 5), "cursor_drag_fleet");
            }
            ...
            if (ii == null) {
                ...
                CURSOR_DRAG_WING = tk.createCustomCursor(ii.getImage(),
                        new java.awt.Point(5, 5), "cursor_drag_wing");
            }
            ...
            if (ii == null) {
                ...
                CURSOR_DRAG_ARMY_NO = tk.createCustomCursor(ii.getImage(),
                        new java.awt.Point(5, 5), "cursor_drag_army_no");
            }
            ...
            if (ii == null) {
                ...
                CURSOR_DRAG_FLEET_NO = tk.createCustomCursor(ii.getImage(),
                        new java.awt.Point(5, 5), "cursor_drag_fleet_no");
            }
            ...
            if (ii == null) {
                ...
                CURSOR_DRAG_WING_NO = tk.createCustomCursor(ii.getImage(),
                        new java.awt.Point(5, 5), "cursor_drag_wing_no");
            }
        } else {
            BAD_ACTION = java.awt.dnd.DragSource.DefaultCopyNoDrop;
            CURSOR_DRAG_ARMY = DEFAULT_CURSOR;
    ...
    private void setScalingParameters() {
        ...
        scaleFactor = mmd.getDisplayParamFloat(MapMetadata.ATT_ZOOM_FACTOR,
                DEFAULT_SCALE_FACTOR);

        int minZoom = mmd.getDisplayParamInt(MapMetadata.ATT_ZOOM_MIN,
                1);        // default minimum: 1%
        int maxZoom = mmd.getDisplayParamInt(MapMetadata.ATT_ZOOM_MAX,
                1600);    // default maximum: 1600%
    ...
    private class MP_GVTRenderListener extends GVTTreeRendererAdapter {
        ...
        public void gvtRenderingCompleted(GVTTreeRendererEvent e) {
            ...
            if (!loaded) {
                ...
                final RenderCommandFactory rcf = mapRenderer
                        .getRenderCommandFactory();
                ...
                RenderCommand rc = rcf
                        .createRCSetTurnstate(mapRenderer, turnState);
                mapRenderer.execRenderCommand(rc);
                ...
                if (isReloading) {
                    ...
                    // then re-render them.
                    scroller.revalidate();
                    rc = ((DMR2RenderCommandFactory) rcf)
                            .createRCRenderAllForced(mapRenderer);
                    mapRenderer.execRenderCommand(rc);
                } else {
                    rc = mapRenderer.getRenderCommandFactory()
                            .createRCRenderAll(mapRenderer);
                    mapRenderer.execRenderCommand(rc);
    ...
    public void reloadMap() {
        ...
        // cleanup this
        if (mapRenderer != null) {
            oldLabelLevel = mapRenderer
                    .getRenderSetting(MapRenderer2.KEY_LABELS);
            mapRenderer.close();
            mapRenderer = null;
        }
