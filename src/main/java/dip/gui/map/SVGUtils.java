...
public class SVGUtils {
     ...
     */
    public static void setTitle(SVGDocument document, SVGElement element,
                                String title) {
        Node titleNode = null;
        Node textNode = null;
     ...
     */
    public static void setDescription(SVGDocument document, SVGElement element,
                                      String description) {
        Node descNode = null;
        Node textNode = null;
     ...
     * <p>
     */
    public static SVGUseElement createUseElement(SVGDocument document,
                                                 String symbolName, String id,
                                                 String attClass, float x,
                                                 float y,
        ...
        SVGUseElement useElement = (SVGUseElement) document
                .createElementNS(SVGDOMImplementation.SVG_NAMESPACE_URI,
    ...
    private static void nodeWalker(Node node, List list, Map map,
        ...
        if (node.getNodeType() == Node.ELEMENT_NODE && ((anySVGElement && node instanceof org.w3c.dom.svg.SVGElement) || (node
            ...
            if (node.hasAttributes()) {
                ...
                Node attrNode = attributes.getNamedItem(
