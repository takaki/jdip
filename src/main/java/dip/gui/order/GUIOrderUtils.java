...
final class GUIOrderUtils {
    ...
    public static float getLineWidth(final MapInfo mapInfo, final String mmdElementName,
        ...
        final float[] widths = mapInfo.getMapMetadata()
                .getOrderParamFloatArray(mmdElementName, mmdElementType);
    ...
    public static SVGUseElement createFailedOrderSymbol(final MapInfo mapInfo,
        ...
        return SVGUtils.createUseElement(mapInfo.getDocument(),
                "#" + DefaultMapRenderer2.SYMBOL_FAILEDORDER, null, // no id
     ...
     */
    public static boolean isDisplayable(final Power power,
     ...
     */
    public static boolean removeChild(final Element parent,
                                      final Element child) {
