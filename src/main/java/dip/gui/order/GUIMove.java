...
public class GUIMove extends Move implements GUIOrder {
     ...
     */
    public transient static final MoveParameter BY_CONVOY = new MoveParameter(
            "BY_CONVOY");
    ...
    public boolean testLocation(StateInfo stateInfo, Location location,
        ...
        if (currentLocNum == 0) {
            ...
            } else if (!GUIOrderUtils.checkBorder(this, location, srcUnitType,
                    stateInfo.getPhase(), sb)) {
    ...
    private SVGElement drawNCOrder(MapInfo mapInfo, float offset,
        ...
        newPtTo = GUIOrderUtils
                .getLineCircleIntersection(ptFrom.x + offset, ptFrom.y + offset,
                        ptTo.x + offset, ptTo.y + offset, ptTo.x + offset,
                        ptTo.y + offset, r);
